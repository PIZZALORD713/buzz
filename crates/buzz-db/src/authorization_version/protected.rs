...
use buzz_auth::{
    AuthContext, AuthorizationLeaseDependencySnapshot, ProofTransport, RouteCapability,
};
...
impl ProtectedPublicationCoordinate {
    ...
    pub fn repository(context: &AuthContext) -> Result<Self> {
...
impl ProtectedPublicationAuthority {
    fn from_context(context: &AuthContext) -> Result<Self> {
