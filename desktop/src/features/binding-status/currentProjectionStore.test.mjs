...
const EPOCH_B = "bbbbbbbb-bbbb-4bbb-9bbb-bbbbbbbbbbbb";
...
test("rejects malformed authors, deadlines, and local epochs", () => {
  for (const candidate of [
    ...
    projection({ connectionEpoch: EPOCH_A.toUpperCase() }),
    projection({ connectionEpoch: "11111111-1111-1111-8111-111111111111" }),
  ]) {
